...
public:
    ...
    KillReason get_reason() const noexcept {
    ...
    static const char* reason_to_string(KillReason r) noexcept {
        switch (r) {
            ...
            case KillReason::HEARTBEAT_MISSED: return "HEARTBEAT_MISSED";
            case KillReason::BOOK_CORRUPTED:   return "BOOK_CORRUPTED";
