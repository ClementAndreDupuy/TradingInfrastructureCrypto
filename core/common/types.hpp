...
namespace trading {
    ...
    enum class ConnectorResult : uint8_t {
        ...
        ERROR_FUTURES_FILTERS_UNAVAILABLE = 9,
        ERROR_FUTURES_PRICE_FILTER_VIOLATION = 10,
        ERROR_FUTURES_QTY_FILTER_VIOLATION = 11,
        ERROR_FUTURES_MIN_NOTIONAL_VIOLATION = 12,
        ERROR_FUTURES_TRIGGER_CONSTRAINT_VIOLATION = 13,
        ERROR_UNKNOWN = 255,
    };
